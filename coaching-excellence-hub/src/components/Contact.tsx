        ...
        <div className="grid lg:grid-cols-[1fr_1.3fr] gap-12 items-start">
          ...
          >
            {contactItems.map((item) => (
              <div
                key={item.title}
                className="flex items-start gap-4 bg-cream rounded-xl p-5 border border-border/50"
              >
          ...
          >
            <form
              ...
              className="bg-primary rounded-2xl p-8 space-y-4"
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <option>School Curriculum (Class 1–12)</option>
